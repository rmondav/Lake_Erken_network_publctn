...
TS_Cafonsi_1_node <-
  read.csv("./Mondav_etal_2020_Erken_network/data/TS_Cafonsi_1_node.csv")
MC_Cafonsi_1_node <-
  read.csv("./Mondav_etal_2020_Erken_network/data/MC_Cafonsi_1_node.csv")

##basal fonsi sp. primary cohort
TS_basal_fonsi_1_node <-
  read.csv("./Mondav_etal_2020_Erken_network/data/TS_basal_fonsi_1_node.csv")
MC_basal_fonsi_1_node <-
  read.csv("./Mondav_etal_2020_Erken_network/data/MC_basal_fonsi_1_node.csv")

##LD12 spp. primary cohort
TS_all_fonsi_1_node <-
  read.csv("./Mondav_etal_2020_Erken_network/data/TS_all_fonsi_1_node.csv")
MC_all_fonsi_1_node <-
  read.csv("./Mondav_etal_2020_Erken_network/data/MC_all_fonsi_1_node.csv")
##Nanopelagicus spp. primary cohort
TS_Nanopel_1_node <-
  read.csv("./Mondav_etal_2020_Erken_network/data/TS_Nanopelagicus_1_node.csv")
MC_Nanopel_1_node <-
  read.csv("./Mondav_etal_2020_Erken_network/data/MC_Nanopelagicus_1_node.csv")
##Planktophila spp. primary cohort
TS_Planktop_1_node <-
  read.csv("./Mondav_etal_2020_Erken_network/data/TS_Planktophila_1_node.csv")
MC_Planktop_1_node <-
  read.csv("./Mondav_etal_2020_Erken_network/data/MC_Planktophila_1_node.csv")
